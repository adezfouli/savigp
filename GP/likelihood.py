...
class Likelihood:
    ...
    def ll_F_Y(self, F, Y):
        """
        Method which calculates p(Y|F), and dp(Y|F)\dlambda, for multiple latent function values, and multiple
        output points.
        ...
        Returns
        -------
        The method is supposed to return matrix P and dP, where: \n
            P[n,s] = p(Y[n,:]| F[s,n,:])\n
        and
    ...
    def nlpd_dim(self):
        """
        This function returns number of NLPD.
        """
        return 1
